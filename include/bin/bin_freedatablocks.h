...
#ifndef __SOFS21_FREEDATABLOCKS_BIN__
#define __SOFS21_FREEDATABLOCKS_BIN__
...
namespace sofs21
{
    ...
    void binReplenishFromCache();

    void binReplenishFromBitmap();
...
#endif /* __SOFS21_FREEDATABLOCKS_BIN__ */
