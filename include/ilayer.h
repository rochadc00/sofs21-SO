...
#ifndef __SOFS21_ILAYER__
#define __SOFS21_ILAYER__
 ...
 *    - \c inodeblocks, to deal with the data blocks of a file (inode)
 ...
 * \remarks In case an error occurs, every function throws an \c SOException.
 *
 * \defgroup c_ilayer ILayer/inodeblocks
 * \ingroup ilayer
