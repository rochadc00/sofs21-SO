...
#ifndef __SOFS21_INODE__
#define __SOFS21_INODE__
...
struct SOInode
{
    ...
    /** \brief user ID of the file owner \anchor owner */
    uint32_t owner;

    /** \brief group ID of the file owner \anchor group */
    uint32_t group;
