/**
 * \file
 * \brief The \b sofs21 system calls
 *
...
#ifndef __SOFS21_SYSCALLS__
#define __SOFS21_SYSCALLS__
...
namespace sofs21
{
    ...
    /**
     * \defgroup evaluation_syscalls Evaluation syscalls
     * \brief Corpus of system calls for evaluation    
     * \defgroup main_syscalls Other main syscalls
     * \brief Corpus of main system calls 
     * */
     ...
     *          <em>user</em>, <em>group</em> and <em>other</em>.
     *
    ...
    /**
     *  \brief Open the sofs21 file system.
     *
    ...
    /**
     *  \brief Close the sofs21 file system.
     *
